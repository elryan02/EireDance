...
3. 'node src/server.js' OR 'npm start' to start server
5. Localhost:3030 in chrome browser.
4. Once on index page, click on the top left tile image on the homescreen to navigate to the Footwork conditioning workout. Click "Add" and specify the name and duration of an exercise to create and personalize your own. 
